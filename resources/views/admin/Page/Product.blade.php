      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <div class="col-md-1"> 
                <div class="form-group">
                  <button type="submit" id="btnGetLink" disabled class="btn btn-primary">Get link</button>
          ...
          <form  id="form" style="display: none" >
            <div class="box-body">
              <div class="col-md-12"> 
                  ...
                  <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" id="originPrice" name="originPrice" placeholder="Enter Images">
                  </div>
                  <div class="form-group">
                    <label>Vender:</label>
            ...
            <div class="box-footer">
              <button type="submit" class="btn btn-primary btn-button" id="submit-ebay">Submit</button>
